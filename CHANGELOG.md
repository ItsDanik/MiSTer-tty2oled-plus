...
- **The console icons are back.** This is the fix 0.6.1b was meant to
  deliver; that tag's release was never published, because a check on the
  test that proves the fix failed. What changed for you is the same:

  Since 0.5.8b the daemon deleted the whole
